...
//        env.setStateBackend(new FsStateBackend("hdfs://10.0.24.116:8020/user/flink/checkpoint"));
//        System.setProperty("HADOOP_USER_NAME","root");

        //指定消费者配置信息
        String groupId = "ods_user_groupid";
        String topic = "qw_ods_user";
        //TODO 1.从kafka中读取数据
